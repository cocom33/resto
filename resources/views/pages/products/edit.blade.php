                ...
                <div class="card">
                    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Stock</label>
                                <input type="number" value="{{ $product->stock }}" class="form-control @error('stock') is-invalid @enderror"
                                    name="stock">
                                @error('stock')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('category_id') is-invalid @enderror" name="category_id">
                                    <option value="{{ $product->category_id }}" class="d-none">{{ $product->category->name }}</option>
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="radio"
                                            ...
                                            checked="{{ $product->is_favorite == 1  ? 'checked' : '' }}" />
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio"
                                            ...
                                            value="0"
                                            class="selectgroup-input"
                                            checked="{{ $product->is_favorite == 0  ? 'checked' : '' }}">
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio"
                                            ...
                                            value="0"
                                            class="selectgroup-input"
                                            checked="{{ $product->status == 0  ? 'checked' : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    data-height="150" name="description" required>{{ $product->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
